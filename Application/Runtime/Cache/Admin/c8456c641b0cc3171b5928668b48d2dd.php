...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">普通用户管理</span></div>
        </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <a class="link-update" href="/AdaAda/index.php/Admin/Player/edit/id/<?php echo ($vo["user_id"]); ?>">修改</a>
                                    <a class="link-del" href="/AdaAda/index.php/Admin/Player/del/id/<?php echo ($vo["user_id"]); ?>" onclick="return confirm('你要删除用户<?php echo ($vo["user_name"]); ?>吗?');">删除</a>
