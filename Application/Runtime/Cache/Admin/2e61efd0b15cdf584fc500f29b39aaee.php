...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">游戏管理</span></div>
        </div>
                ...
                <div class="result-content">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo ($vo["game_downloads"]); ?></td>
                                <td>
                                    <?php if($vo['game_pic'] != null): ?><!-- neq意味不等于，null为空 -->
                                    <img src="/AdaAda<?php echo ($vo["game_pic"]); ?>" height="30">
                                    <?php else: ?>
                                        暂无图片<?php endif; ?>
                                </td>                 
                                
                                 <td>
                                <?php if($vo['game_reco'] == 1): ?><span style="color: red;">已推荐</span>
                                <?php else: ?>
                                未推荐<?php endif; ?>
                                </td>
                                
                                <td>
                                <?php if($vo['game_state'] == 1): ?><span style="color: red;">已过审</span>
                                <?php else: ?>
                                未过审<?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <a class="link-update" href="/AdaAda/index.php/Admin/Game/edit/id/<?php echo ($vo["game_id"]); ?>">修改</a>
                                    <a class="link-del" href="/AdaAda/index.php/Admin/Game/del/id/<?php echo ($vo["game_id"]); ?>" onclick="return confirm('你要删除栏目<?php echo ($vo["game_name"]); ?>吗?');">删除</a>
