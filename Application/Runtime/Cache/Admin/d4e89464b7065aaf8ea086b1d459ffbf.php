...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <form action="<?php echo U('Class/add');?>" method="get">
        <input type="text" name="class_name" value="请输入分类名">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <a class="link-update" href="/AdaAda/index.php/Admin/Class/edit/id/<?php echo ($vo["class_id"]); ?>">修改</a>
                                    <a class="link-del" href="/AdaAda/index.php/Admin/Class/del/id/<?php echo ($vo["class_id"]); ?>" onclick="return confirm('你要删除分类<?php echo ($vo["class_name"]); ?>吗?');">删除</a>
