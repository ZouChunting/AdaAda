...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">开发者管理</span></div>
        </div>
             
        <div  class="result-wrap">
        <form action="<?php echo U('Dev/add');?>" method="get">
        <input type="text" name="developer_name" value="请输入用户名">
        <input type="text" name="developer_pwd" value="请输入密码">
        <input type="text" name="developer_email" value="请输入邮箱">
        <input type="text" name="developer_address" value="请输入地址">
        <input type="submit" class="btn btn-primary btn2" value="新增">
        </form>
        </div>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo ($vo["developer_id"]); ?></td>
                                <td><?php echo ($vo["developer_name"]); ?></td>
                                <td><?php echo ($vo["developer_pwd"]); ?></td>
                                <td><?php echo ($vo["developer_email"]); ?></td> 
                                <td><?php echo ($vo["developer_address"]); ?></td>                                                                                                                                              
                                
                                <td>
                                    <a class="link-update" href="/AdaAda/index.php/Admin/Dev/edit/id/<?php echo ($vo["developer_id"]); ?>">修改</a>
                                    <a class="link-del" href="/AdaAda/index.php/Admin/Dev/del/id/<?php echo ($vo["developer_id"]); ?>" onclick="return confirm('你要删除开发者<?php echo ($vo["user_name"]); ?>吗?');">删除</a>
