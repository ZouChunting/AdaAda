    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                ...
                <input type="hidden" name="user_sex" value="<?php echo ($users["user_sex"]); ?>">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="user_pwd" size="50" value="<?php echo ($users["user_pwd"]); ?>" type="text">
                                </td>
                            </tr>
