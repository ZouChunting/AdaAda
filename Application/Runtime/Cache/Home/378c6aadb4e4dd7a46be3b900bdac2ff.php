        ...
        <div class="header">
            ...
            <nav class="navbar" role="navigation">
                <ul class="nav">
                    ...
                    <li><a href="/AdaAda/index.php/Home/Index/class">分类查看</a></li>  
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list">
     ...
     <div class="list page b-page">
      ...
      <div class="sticky-content-spacer">
           ...
           <!-- Desktop Sidebar -->
           <form action="<?php echo U('List/searchlist');?>" method="post">
           <input class="form-control" type="text" name="key">
           <div style = "text-align:right;"> 
           <input class="button button2" type="submit" value="搜索">
           </div>
           </form>
