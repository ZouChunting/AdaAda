...
<div class="wrapper cls">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list">
          <ul>
            <li>
                <h1 class="title"><a href="/AdaAda/index.php/Home/Index/game/id/<?php echo ($vo["game_id"]); ?>" ><?php echo ($vo["game_name"]); ?></a></h1>
                <div class="info"><span><?php echo ($vo["game_date"]); ?></span></div>
                <div class="thumb">
                <a href="/AdaAda/index.php/Home/Index/game/id/<?php echo ($vo["game_id"]); ?>" >
                <?php if($vo['game_pic'] != null): ?><img width="1200" height="630" src="/AdaAda<?php echo ($vo["game_pic"]); ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" />
                <?php else: ?>
                <img width="1200" height="630" src="/AdaAda/Uploads/暂无图片.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" /><?php endif; ?>
                </a></div>
            </li>
     ...
     <div class="list page b-page">
      ...
      <div class="sticky-content-spacer">
           ...
           <!-- Desktop Sidebar -->
           <form action="<?php echo U('List/classlist');?>" method="post">
           <select style="width:100%;height:30px;border-style:none;color:#767676;" id="gameclass" name="gameclass">  
           ...
           <input class="button button2" type="submit" value="查看">
           </div>
           </form>
